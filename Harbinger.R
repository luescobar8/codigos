...
evaluate <- function(events, reference, 
                     metric=c("confusion_matrix","sensitivity","specificity","pos_pred_value","neg_pred_value","precision",
                              "recall","F1","prevalence","detection_rate","detection_prevalence","balanced_accuracy")){
  #browser()
  ...
  func <-
    switch(metric,
           "confusion_matrix" = function(data, reference, ...) caret::confusionMatrix(factor(data),factor(reference),...)$table,
           "sensitivity" = function(data, reference, ...) caret::confusionMatrix(factor(data),factor(reference),...)$byClass["Sensitivity"],
           "specificity" = function(data, reference, ...) caret::confusionMatrix(factor(data),factor(reference),...)$byClass["Specificity"],
           "pos_pred_value" = function(data, reference, ...) caret::confusionMatrix(factor(data),factor(reference),...)$byClass["Pos Pred Value"],
           "neg_pred_value" = function(data, reference, ...) caret::confusionMatrix(factor(data),factor(reference),...)$byClass["Neg Pred Value"],
           "precision" = function(data, reference, ...) caret::confusionMatrix(factor(data),factor(reference),...)$byClass["Precision"],
           "recall" = function(data, reference, ...) caret::confusionMatrix(factor(data),factor(reference),...)$byClass["Recall"],
           "F1" = function(data, reference, ...) caret::confusionMatrix(factor(data),factor(reference),...)$byClass["F1"],
           "prevalence" = function(data, reference, ...) caret::confusionMatrix(factor(data),factor(reference),...)$byClass["Prevalence"],
           "detection_rate" = function(data, reference, ...) caret::confusionMatrix(factor(data),factor(reference),...)$byClass["Detection Rate"],
           "detection_prevalence" = function(data, reference, ...) caret::confusionMatrix(factor(data),factor(reference),...)$byClass["Detection Prevalence"],
           "balanced_accuracy" = function(data, reference, ...) caret::confusionMatrix(factor(data),factor(reference),...)$byClass["Balanced Accuracy"]
    )
  
  do.call(func,c(list(detected_vec),list(reference_vec)))
}
